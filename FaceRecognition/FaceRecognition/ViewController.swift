...
//  FaceRecognition
//
//  Created by Ishmam Islam on 19/9/18.
...
class ViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    func detect()
    {
        ...
        let faceDectector = CIDetector(ofType: CIDetectorTypeFace, context: nil, options: accuracy)
        let faces = faceDectector?.features(in: myImage, options: [CIDetectorSmile:true])
